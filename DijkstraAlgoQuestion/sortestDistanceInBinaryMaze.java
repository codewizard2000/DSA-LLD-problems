...
// instead of using priority queue we can use here queue and save logn time
// because queue will store in asending order so no need to PriorityQueue
//start from start point check if its one and go in four direction add it in queue
// add the distance in 2d array every time onces you add the element in  queue

public class sortestDistanceInBinaryMaze {
    ...
    public static void main(String[] args) {
        ...
        sortestDistanceInBinaryMaze obj = new sortestDistanceInBinaryMaze();
